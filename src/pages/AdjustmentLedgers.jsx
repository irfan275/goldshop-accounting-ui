...
import { deleteLedger, getLedger } from "../services/adjustmentLedgerService";
...
const bankEntries = Object.entries(balance || {}).filter(([k]) =>
  ...
  {/* LEFT */}
  <h3 className="mb-0">Adjustment Ledgers</h3>
  ...
  <div className="d-flex gap-2">
    ...
    <button
      ...
      onClick={() => navigate("/adjustmentLedger/add")}
    >
      Add Entry
    </button>
    {/* <button
                      ...
                      {!isTotal && (
                        <>
                          <button
                            ...
                            onClick={() => navigate(`/adjustmentLedger/edit/${item.id}`)}
                          >
                            Edit
                          </button>
...
export default AdjustmentLedgers;