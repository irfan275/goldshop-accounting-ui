                  ...
                  if (isTotal) {
                    rows.push(
                      <tr key={"closing-" + index} className="table-dark text-white">
                        ...
                        <td colSpan="2" style={{backgroundColor:'green'}}>{(item.cash.closing+item.bank.closing).toFixed(3)}</td>
                    ...
                    if (isTotal) {
                      rows.push(
                        <tr key={"closing-" + index} className="table-primary text-white">
                          ...
                          <td colSpan="2" style={{backgroundColor:'green'}}>{(item.cash+item.bank).toFixed(3)}</td>
