...
import { deleteLedger, getLedger } from "../services/purchaseLedgerService";
...
const bankEntries = Object.entries(balance || {}).filter(([k]) =>
  ...
  {/* LEFT */}
  <h3 className="mb-0">Purchase Ledgers</h3>
  ...
  <div className="d-flex gap-2">
    ...
    <button
      ...
      onClick={() => navigate("/purchaseLedger/add")}
    >
      Add Entry
    </button>
    {/* <button
...
export default PurchaseLedgers;